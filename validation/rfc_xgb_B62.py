...
for v in  allmixdfs21:
    ...
    rfc_B62_mcc.append(metrics.matthews_corrcoef(y_test_enc, rfc_predictions).round(3))
...
xgb_B62_mcc.append(metrics.matthews_corrcoef(y_test_enc, xgb_predictions).round(3))
