...
# trouble with None value in some data --> write to csv and check it out
x_test.dropna()
x_test.pos1.dropna()
pipe.fit(X_train.dropna(), y_train)
predictions = pipe.predict(x_test.dropna())
predictions

print(metrics.confusion_matrix(y_test.dropna(), predictions))
